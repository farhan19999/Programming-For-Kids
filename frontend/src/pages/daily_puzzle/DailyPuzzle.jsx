...
export default function DailyPuzzle() {
    ...
    useEffect(() => {
        axios.get(`${server_url}/api/puzzles/date/${today}`).then(response => {
    ...
    return (
        <>
            ...
            <div className="container">
                ...
                <div className="row">
                    <CodeBlock text={puzzle.puzzle_code} language={puzzle.language} theme={dracula} wrapLongLines={true} />
                </div>
                <div className="row">
                ...
                <div className="row text-center justify-content-center">
                    <div className="col-4" >
                        <Button size={'sm'} variant="outline-secondary" id="submitButtonId" onClick={handleSubmit}>
                            Submit
                        </Button>
                    </div>
