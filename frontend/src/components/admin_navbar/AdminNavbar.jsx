    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
            <div className="container-fluid" style={{ height: "50px" }}>
                <NavLink className="navbar-brand" to="/admin">Programming For Kids</NavLink>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <NavLink className="nav-link active" to="/admin/miniprojects">Mini-Project</NavLink>
                        </li>

                        <li className="nav-item">
                            <NavLink className="nav-link active" to="/admin/daily-puzzle">Daily-Puzzle</NavLink>
                        </li>
                        {/* <li className="nav-item">
