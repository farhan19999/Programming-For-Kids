  ...
  <div class="container p-4">
    <div class="row">
      <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
        <h5 class="text-light text-uppercase">Link</h5>
      ...
      <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
        <h5 class="text-light text-uppercase mb-0">HELP</h5>
      ...
      <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
        <h5 class="text-light text-uppercase">Explore</h5>
      ...
      <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
        <h5 class="text-light text-uppercase mb-0">Get in touch</h5>
