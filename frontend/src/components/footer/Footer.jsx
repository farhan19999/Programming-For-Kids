      ...
      <div className="container p-4">
        <div className="row">
          <div className="col-lg-3 col-md-6 mb-4 mb-md-0">
            <h5 className="text-light text-uppercase">Link</h5>
          ...
          <div className="col-lg-3 col-md-6 mb-4 mb-md-0">
            <h5 className="text-light text-uppercase mb-0">HELP</h5>
          ...
          <div className="col-lg-3 col-md-6 mb-4 mb-md-0">
            <h5 className="text-light text-uppercase">Explore</h5>
          ...
          <div className="col-lg-3 col-md-6 mb-4 mb-md-0">
            <h5 className="text-light text-uppercase mb-0">Get in touch</h5>
