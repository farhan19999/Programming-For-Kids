	...
	<div class="card-body">
		<div class="account-settings">
			<div class="user-profile">
				...
				<h5 class="user-name">Arif Faisal</h5>
				<h6 class="user-email">ariffaisal18.19@gmail.com</h6>
			</div>
			<div class="about">
				<h5>About</h5>
...
<div class="card h-100">
	<div class="card-body">
		<div class="row gutters">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="date" class="form-control" id="website" placeholder="Birth Date"/>
				</div>
			</div>
		</div>
		<div class="row gutters">
        ...
        <div class="row gutters">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<h6 class="mb-2 text-primary">Password</h6>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="phone" placeholder="Confirm New Password"/>
				</div>
			</div>
		</div>
